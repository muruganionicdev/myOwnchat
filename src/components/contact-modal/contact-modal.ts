...
export class ContactModal {
	contact = null
	constructor(private viewCtrl: ViewController, private params: NavParams, private navCtrl: NavController, private callService: CallService, private contactService: ContactService,private chatService: ChatService) {
	}
